...
public interface HistoriaFisiologicaRepository extends JpaRepository<HistoriaFisiologica, UUID>{
    ...
    @Query(value = "SELECT hf.id, hf.id_paciente, hf.metodo_parto, hf.experiencia_parto, hf.saude_infancia FROM historia_fisiologica hf WHERE hf.id_paciente = :idPaciente", nativeQuery = true)
